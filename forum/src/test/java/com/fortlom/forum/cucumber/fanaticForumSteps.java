...
public class fanaticForumSteps {
    ...
    public void that_the_fan_is_in_the_section(String string) {url=url+"/api/v1/forumservice/";}
    @Given("click on the “+” fanatic button")
    public void click_on_the_fanatic_button() {url=url+"user/";}
    ...
    public void click_on_create_fanatic() {url=url+"1/forums";}
